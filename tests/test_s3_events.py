...
def test_s3_put_triggers_sqs_notification(s3_client, sqs_client, temporary_bucket, temporary_queue) -> None:
    """Verify that uploading an object to S3 triggers an SQS notification with correct metadata."""
    queue_arn = get_queue_arn(sqs_client, temporary_queue)
    ...
    # Fitlering LocalStack test notification
